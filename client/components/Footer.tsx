    ...
    <footer className="bg-gradient-to-br from-primary to-secondary text-foreground py-12">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8 mb-6 sm:mb-8">
          {/* About */}
          <div>
            <h3 className="text-xl sm:text-2xl font-display font-bold mb-3 sm:mb-4 flex items-center gap-2">
              <span>⭐</span> <span className="hidden sm:inline">Estrela da Manhã</span><span className="sm:hidden">Estrela</span>
            </h3>
            ...
            <div className="space-y-2 sm:space-y-3">
              ...
              <div className="flex items-center gap-2 sm:gap-3">
                ...
                <a
                  ...
                  className="text-foreground/70 hover:text-foreground transition-colors text-xs sm:text-sm"
                >
                  (31) 99871-1551
                </a>
              </div>
          ...
          <div>
            ...
            <div className="flex gap-3 sm:gap-4">
              <a
                ...
                className="w-9 sm:w-10 h-9 sm:h-10 bg-foreground/20 hover:bg-foreground/30 rounded-full flex items-center justify-center transition-colors"
                aria-label="WhatsApp"
              >
        ...
        <div className="border-t border-foreground/20 pt-6 sm:pt-8 text-center text-foreground/60 text-xs sm:text-sm">

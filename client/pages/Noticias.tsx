    ...
    <div className="min-h-screen flex flex-col bg-white">
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 md:gap-8">
            {newsItems.map((item) => (
              ...
              >
                {/* Image */}
                <div className="h-40 sm:h-48 bg-gradient-to-br from-primary/20 to-secondary/20 flex items-center justify-center overflow-hidden group-hover:scale-105 transition-transform duration-300">
                  <span className="text-5xl sm:text-6xl md:text-7xl">{item.image}</span>
                </div>

                {/* Content */}
                <div className="p-4 sm:p-6">
                  {/* Meta */}
                  <div className="flex items-center gap-3 sm:gap-4 text-xs sm:text-sm text-foreground/60 mb-2 sm:mb-3">
                  ...
                  {/* Excerpt */}
                  <div className="text-foreground/70 text-xs sm:text-sm mb-3 sm:mb-4 whitespace-pre-wrap line-clamp-3">
                    {item.excerpt}
                  </div>

                  {/* Author */}
                  <div className="flex items-center gap-2 text-xs sm:text-sm text-foreground/60 pt-3 sm:pt-4 border-t border-gray-100">
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 max-w-5xl mx-auto">
            {[
              ...
              <div
                key={index}
                className="bg-white rounded-2xl p-4 sm:p-6 border border-gray-100 hover:shadow-lg transition-shadow"
              >
      ...
      <section className="py-12 sm:py-16 md:py-24 bg-white">
        <div className="container mx-auto px-4 max-w-2xl">
          <div className="bg-gradient-to-br from-primary/10 to-secondary/10 rounded-3xl p-6 sm:p-8 md:p-12 border border-primary/20">
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-display font-bold text-foreground mb-3 sm:mb-4 text-center">
              Fique Informado
            </h2>
            <p className="text-center text-foreground/70 mb-6 sm:mb-8 text-sm sm:text-base">
            ...
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4">
              <a
                ...
                className="flex-1 inline-flex items-center justify-center gap-2 bg-primary hover:bg-primary/90 text-white px-4 sm:px-6 py-2 sm:py-3 rounded-full font-semibold transition-colors text-sm sm:text-base"
              >
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="flex-1 inline-flex items-center justify-center gap-2 border-2 border-primary text-primary hover:bg-primary/5 px-4 sm:px-6 py-2 sm:py-3 rounded-full font-semibold transition-colors text-sm sm:text-base"
              >
                <svg className="w-4 sm:w-5 h-4 sm:h-5" fill="currentColor" viewBox="0 0 24 24">

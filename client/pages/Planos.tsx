            ...
            {plans.map((plan, index) => (
              <div
                ...
                className={`relative rounded-3xl overflow-hidden transition-all duration-300 ${
                  plan.highlight
                    ? "md:scale-105 bg-gradient-to-br from-primary to-purple-600 text-white shadow-2xl"
              ...
              >
                ...
                <div className="p-8 md:p-6 lg:p-8">
                  ...
                  <div className={`mb-6 ${plan.highlight ? "text-white/80" : "text-foreground/60"}`}>
                    <p className="text-sm">{plan.hours}</p>
                  </div>

                  <div className="mb-8">
                    <div className={`text-4xl font-bold ${plan.highlight ? "text-white" : "text-primary"}`}>
                      {plan.price}
                    </div>
                    <p className={`text-sm ${plan.highlight ? "text-white/70" : "text-foreground/60"}`}>
                      {plan.period}
                    </p>
                  </div>
                  ...
                  <a
                    ...
                    className={`w-full inline-flex items-center justify-center gap-2 py-3 rounded-full font-semibold transition-all duration-300 ${
                      plan.highlight

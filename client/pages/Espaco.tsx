      ...
      <section className="py-12 sm:py-16 md:py-24 bg-white">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8 md:gap-12 items-center">
            <div>
              <h2 className="text-3xl sm:text-4xl md:text-4xl font-display font-bold text-foreground mb-4 sm:mb-6">
                Localização Central
              </h2>
              <div className="bg-gradient-to-br from-primary/10 to-secondary/10 rounded-2xl p-4 sm:p-6 md:p-8 mb-6 sm:mb-8">
                <div className="flex gap-3 sm:gap-4 items-start">
                  <MapPin className="w-5 sm:w-6 h-5 sm:h-6 text-primary flex-shrink-0 mt-1" />
                  <div className="min-w-0">
                    <p className="font-bold text-foreground text-base sm:text-lg mb-2">Rua Nicias Continentino, 944</p>
                    <p className="text-foreground/60 text-sm mb-1">Nova Gameleira</p>
                    <p className="text-foreground/60 text-sm mb-4">Belo Horizonte - MG</p>
                    <a
            ...
            <div className="relative h-64 sm:h-80 md:h-96 w-full order-first lg:order-last">
              <div className="bg-gradient-to-br from-primary/20 to-secondary/20 rounded-3xl h-full flex items-center justify-center">
                <iframe
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 md:gap-8">
            {facilities.map((facility, index) => {
              ...
              return (
                <div
                  key={index}
                  className="group bg-white rounded-2xl p-4 sm:p-6 md:p-8 shadow-sm hover:shadow-xl border border-gray-100 hover:border-primary/30 transition-all duration-300"
                >
                  <div className="w-10 sm:w-12 h-10 sm:h-12 bg-primary/10 rounded-xl flex items-center justify-center mb-3 sm:mb-4 group-hover:bg-primary/20 transition-colors">
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6 md:gap-8 max-w-4xl mx-auto">
            {[
              ...
              <div
                key={index}
                className="flex gap-3 sm:gap-4 pb-4 sm:pb-6 border-b border-gray-200 last:border-b-0"
              >
                <div className="w-10 sm:w-12 h-10 sm:h-12 rounded-full bg-secondary/20 flex items-center justify-center flex-shrink-0">
                  <span className="text-lg sm:text-xl">✓</span>
                </div>
                <div className="min-w-0">
                  <h3 className="font-bold text-foreground mb-1 text-sm sm:text-base">{feature.title}</h3>
                  <p className="text-foreground/60 text-xs sm:text-sm">{feature.desc}</p>
                </div>
              </div>
            ))}
          </div>
